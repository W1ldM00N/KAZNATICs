...
async function showForecast() {
  ...
  // Фейковые данные вместо Django API
...
function generateFakeData() {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    temp.push(273 + 10 + Math.random() * 15);
    humidity.push(40 + Math.random() * 40);
    clouds.push(Math.random());
    rain.push(Math.random() * 3);
  }
  return { dates, temp, humidity, clouds, rain };
}
